      ...
      <div className="App">
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            <Route path="pagos" element={<div className="module"><div className="module-header"><div className="module-title-section"><h1 className="module-title">Pagos y Liquidaciones</h1><p className="module-subtitle">Sistema de liquidaciones automáticas y reportería financiera</p></div></div><div className="content-placeholder"><h3>Módulo de Pagos</h3><p>Liquidación automática de sellers basada en pedidos entregados con configuración de cuentas bancarias.</p></div></div>} />
