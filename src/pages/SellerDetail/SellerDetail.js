              ...
              <div className="config-item">
                <div className="config-header">
                  <div className="config-info">
                    ...
                    <p className="config-description">
                      Configure las opciones de facturación específicas para este seller después de liquidaciones
                    </p>
                  </div>
                </div>
                
                <div className="billing-seller-options">
                  <div className="form-group">
                    <label className="checkbox-label">
                      <input
                        type="checkbox"
                        checked={seller.automaticBilling || false}
                        onChange={(e) => setSeller(prev => ({
                          ...prev,
                          automaticBilling: e.target.checked
                        }))}
                      />
                      <span className="checkbox-content">
                        <span className="option-title">Facturación Automática</span>
                        <span className="option-description">
                          Facturar automáticamente a este seller después de liquidar usando la configuración global del sistema
                        </span>
                      </span>
                    </label>
                  </div>

                  {seller.automaticBilling && (
                    <div className="billing-seller-details">
                      <div className="form-group">
                        <label className="checkbox-label">
                          <input
                            type="checkbox"
                            checked={seller.emailDelivery || false}
                            onChange={(e) => setSeller(prev => ({
                              ...prev,
                          ...
                          <span className="checkbox-content">
                            ...
                            <span className="option-description">
                              Enviar automáticamente los XMLs y facturas por correo a este seller
                            </span>
                          </span>
                        </label>
                      </div>
                      ...
                      <div className="billing-info">
                        <div className="info-box">
                          ...
                          <span className="info-text">
                            La facturación utilizará el proveedor configurado en el módulo de pagos del sistema (PAC tercero, ERP o endpoint personalizado).
                          </span>
                        </div>
                      </div>
                    </div>
